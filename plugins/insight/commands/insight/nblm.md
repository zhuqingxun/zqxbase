---
description: 使用 NotebookLM 生成增强输出（精美 PPTX、播客音频、视频等）。需已有 NotebookLM notebook。当用户提到"生成播客"、"做视频"、"精美PPT"、"nblm"、"NotebookLM 增强"时触发。
argument-hint: [notebook ID 或研究主题名，可选指定输出类型如 audio/slides/video]
---
